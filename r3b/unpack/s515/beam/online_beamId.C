...
void online_beamId()
{
    ...
    TString filename =
        " --stream=lxlanddaq01:9001 --allow-errors --input-buffer=50Mi"; // PSPx and Incoming ID online analysis
    ...
    R3BOnlineSpectraLosStandalone* r3bOnlineSpectra =
        new R3BOnlineSpectraLosStandalone("OnlineSpectraLosStandalone", 1);
